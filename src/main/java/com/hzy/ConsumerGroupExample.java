...
public class ConsumerGroupExample {
    private static final Logger logger = LogManager.getLogger(ConsumerGroupExample.class);
    ...
    public void run(Integer a_numThreads) {
        ...
        for (final KafkaStream stream : streams) {
            executor.submit(new ConsumerSave(stream, threadNumber));
            threadNumber++;
        }
    }
    ...
    public static void main(String[] args) {
        ...
        Integer threads = Integer.parseInt(PropertiesUtil.getValue("ConsumerGroupExampleThreads"));
