...
public class DateUtil {
    ...
    public static String getDateBySimpleDateFormat(String sdf) {
        Date now = new Date();
        SimpleDateFormat dateFormat = new SimpleDateFormat(
                sdf);
        return dateFormat.format(now);
     ...
     * @return
     */
    public static java.sql.Timestamp getTimestamp(Long currentTimeMillis) {
        java.sql.Timestamp d = new java.sql.Timestamp(currentTimeMillis);
        return d;
    }
}  
